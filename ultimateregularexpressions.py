#Regular expressions specify a pattern of text to search.  Regexes or re for short are descriptions for a sequence of characters such as letters, numbers, and special characters forming a pattern.  For example, a \d in regex stands for a digit character from 0 to 9.  Regex \d\d\d-\d\d\d-\d\d\d\d is a phone number string of three numbers, a hyphen, three numbers, a hyphen, and four numbers.  Any other string doesn't match regex \d\d\d-\d\d\d-\d\d\d\d.  Search text, text files, CSV files, and Excel files.  Use the built-in module re.  There are additional third party modules supporting regular expressions.
...
import re
#The search() method searches the string for a match.  The search method looks for the first occurrence which matches the regular expression.  If there is a match, then it returns a Match object of type SRE_Match containing the matching substring.  re.search(pattern, string, flags=0).  The pattern is the regular expression used in the matching process, string is the string to be searched, flags are optional flags to modify the search operation; for example, flags=re.IGNORECASE for case insensitive.  The match object's group method returns the substring or actual matched text.  The search() method returns None if the regex pattern is not found in the string.
...
#The match() method searches the beginning of a string for a match.  match() method works the same as search() method.  match() method checks at the beginning of the string.  search() method checks anywhere in the string.
...
#The asterisk to find zero or more custom character class.  The asterisk * flags the group to the left of *.
#The period matches any single character except the new line.  Need the period in front of the asterisk or error message appears.  The period asterisk default matches as much text as possible.
...
#Open file all lowercase strings
importtextfile = re.findall(r"\w+", open("moby01.txt").read().lower())
print(importtextfile) #print ['call', 'me', 'ishmael', 'some', 'years', 'ago', 'never', 'mind', 'how', 'long', 'precisely', 'having', 'little', 'or', 'no', 'money', 'in', 'my', 'purse', 'and', 'nothing', 'particular', 'to', 'interest', 'me', 'on', 'shore', 'i', 'thought', 'i', 'would', 'sail', 'about', 'a', 'little', 'and', 'see', 'the', 'watery', 'part', 'of', 'the', 'world', 'it', 'is', 'a', 'way', 'i', 'have', 'of', 'driving', 'off', 'the', 'spleen', 'and', 'regulating', 'the', 'circulation', 'whenever', 'i', 'find', 'myself', 'growing', 'grim', 'about', 'the', 'mouth', 'whenever', 'it', 'is', 'a', 'damp', 'drizzly', 'november', 'in', 'my', 'soul', 'whenever', 'i', 'find', 'myself', 'involuntarily', 'pausing', 'before', 'coffin', 'warehouses', 'and', 'bringing', 'up', 'the', 'rear', 'of', 'every', 'funeral', 'i', 'meet', 'and', 'especially', 'whenever', 'my', 'hypos', 'get', 'such', 'an', 'upper', 'hand', 'of', 'me', 'that', 'it', 'requires', 'a', 'strong', 'moral', 'principle', 'to', 'prevent', 'me', 'from', 'deliberately', 'stepping', 'into', 'the', 'street', 'and', 'methodically', 'knocking', 'people', 's', 'hats', 'off', 'then', 'i', 'account', 'it', 'high', 'time', 'to', 'get', 'to', 'sea', 'as', 'soon', 'as', 'i', 'can', 'this', 'is', 'my', 'substitute', 'for', 'pistol', 'and', 'ball', 'with', 'a', 'philosophical', 'flourish', 'cato', 'throws', 'himself', 'upon', 'his', 'sword', 'i', 'quietly', 'take', 'to', 'the', 'ship', 'there', 'is', 'nothing', 'surprising', 'in', 'this', 'if', 'they', 'but', 'knew', 'it', 'almost', 'all', 'men', 'in', 'their', 'degree', 'some', 'time', 'or', 'other', 'cherish', 'very', 'nearly', 'the', 'same', 'feelings', 'towards', 'the', 'ocean', 'with', 'me', 'there', 'now', 'is', 'your', 'insular', 'city', 'of', 'the', 'manhattoes', 'belted', 'round', 'by', 'wharves', 'as', 'indian', 'isles', 'by', 'coral', 'reefs', 'commerce', 'surrounds', 'it', 'with', 'her', 'surf', 'right', 'and', 'left', 'the', 'streets', 'take', 'you', 'waterward', 'its', 'extreme', 'downtown', 'is', 'the', 'battery', 'where', 'that', 'noble', 'mole', 'is', 'washed', 'by', 'waves', 'and', 'cooled', 'by', 'breezes', 'which', 'a', 'few', 'hours', 'previous', 'were', 'out', 'of', 'sight', 'of', 'land', 'look', 'at', 'the', 'crowds', 'of', 'water', 'gazers', 'there']
'''
...
xmasregex = re.compile(r"\d+\s\w+") #xmasregex \d+ match text with one or more numeric digits, \s a whitespace character, and \w+ one or more letter or digit or underscore characters.  Plus sign + to find one or more custom character class.
...
#Question mark ? to find zero or one custom character class.  The question mark ? flags the group to the left of ?.
...
#Asterisk to find zero or more custom character class.  The asterisk * flags the group to the left of *.
...
#Plus sign + to find one or more custom character class.  The plus + flags the group to the left of +.
...
#Use curly brackets for specific repetitions.  If you have a group to repeat a specific number of times, then type the number in curly brackets to the right of the group.  The quantifier matches at least the numbered occurrences.  Curly brackets {lowernumberinclusive, uppernumberinclusive} quantifier matches between lowernumber and optional uppernumber inclusive occurrences.  If you have a group to repeat a specific number of times, then type the number in curly brackets to the right of the group.  (Ha){3} searchs for HaHaHa.  (Ha){3,5} searchs for HaHaHa, HaHaHaHa, and HaHaHaHaHa.  (Ha){3,} searchs for three or more Ha.  (Ha){0,6} searches for zero to six instances of Ha.  (Ha)(Ha)(Ha) is the same as (Ha){3}.  (Ha)(Ha)(Ha)|(Ha)(Ha)(Ha)(Ha)|(Ha)(Ha)(Ha)(Ha)(Ha) is the same as (Ha){3,5}.
...
#The sub() method substitutes next text in place of the patterns.  Replace all text in search results by default.  Replace occurrences of the regular expression pattern in the string with the repl string.  re.sub(pattern, repl, string, max=0).  Set count=number to specify the maximum number of replacements.
...
#The split() method separates a string to list with a delimiter.  The examples separates each string by a comma and its whitespaces to a list.  Set maxsplit=number to specify the maximum number of splits.  re.split(pattern, string, maxsplit=0,flags=0).
#RM:  Reference reminder question mark ? matches zero or one occurrence.  Asterik * matches zero or more occurrences.  Plus sign + matches one or more occurrences.
...
#Search between strings.  RM:  Reference reminder question mark ? matches zero or one occurrence.  Asterik * matches zero or more occurrences.  Plus sign + matches one or more occurrences.  Period matches any single character except for a new line.
...
#assigngroupnamescompileobject = re.compile(r"(?P<last>[-a-zA-Z]+), ((?P<middle>[-a-zA-Z]+),)? (?P<first>[-a-zA-Z]+): (?P<phone>([(]\d{3}[)]-)?\d{3}-\d{4}") #Last name, comma, space, first name, space, middle name optional, colon, space, phone number for which area code optional.  RM:  Reference reminder question mark ? matches zero or one occurrence.  Asterik * matches zero or more occurrences.  Plus sign + matches one or more occurrences.  Period matches any single character except for a new line.
