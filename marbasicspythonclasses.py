...
class Thenewbostongirl():
    classvariablegender = "female"
    def __init__(self, name):
        self.nameproper = name #self.name is an instance variable


rachelobject = Thenewbostongirl("Rachel")
stankyobject = Thenewbostongirl("Stanky")
print(rachelobject.classvariablegender) #print female
print(stankyobject.classvariablegender) #print female
print(rachelobject) #print <__main__.Thenewbostongirl object at 0x7f4ae266e860>
print(rachelobject.nameproper) #print Rachel
print(stankyobject.nameproper) #print Stanky
class Thenewbostongirl:
    gender = "female"
    def __init__(self, name):
...
boatinstance = Boat()
print(boatinstance) #print <__main__.Boat object at 0x7f6aff1c95f8>
print(id(boatinstance)) #print 140097523324408
boatinstance2 = Boat()
print(boatinstance2) #print <__main__.Boat object at 0x7f6aff1c9470>
print(id(boatinstance2)) #print 140097523324016

class Boatcargoweight():
    def __init__(self):
        self.cargoweight = 23
def changecargoweight(shipweight):
    shipweight.cargoweightanother = 45


boatinstance = Boatcargoweight()
print(boatinstance.cargoweight) #print 23
print(id(boatinstance.cargoweight)) #print 10915200
changecargoweight(boatinstance)
print(boatinstance.cargoweightanother) #print 45
print(id(boatinstance.cargoweightanother)) #print 10915904
class Boat():
    def __init__(self):
...
defineobjectadd1.choosemathoperation(mathoperationsadd, 3, 5) #print 8.  These are methods.
defineobjectmultiply1 = FunctionOutsideClass()
defineobjectmultiply1.choosemathoperation(mathoperationsmultiply, 4, 8) #print 32.  These are methods.
defineobjectadd2 = FunctionOutsideClass()
defineobjectadd2.choosemathoperation(mathoperationsadd, 100, 333) #print 433.  These are methods.
class ClassName():
    def __init__(self):
...
defineobjectThenewbostonchildbucky.printlastname() #return Roberts
defineobjectThenewbostonchildraymond = Thenewbostonchild()
defineobjectThenewbostonchildraymond.printfirstname() #return Bucky
defineobjectThenewbostonchildraymond.printlastname() #return Roberts
...
class Child(Parent):
    def printfirstname(self):
        print("firstnamehere")
    def printlastname(self):
        print("Override Parent() class lastnamehere")


raymond = Child()
raymond.printfirstname() #print firstnamehere
raymond.printlastname() #print Override Parent() class lastnamehere
...
class Shroom():
    def eatshroom(self):
        print("Now I am big!")
class BigMarioInheritsMarioandShroom(Mario, Shroom):
    print("Pass")


thebm = BigMarioInheritsMarioandShroom() #print Pass
thebm.move() #print I am moving!
thebm.eatshroom() #print Now I am big!
class Mario():
